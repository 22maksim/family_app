...
const file_api_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x14api/proto/user.proto\x12\x04user\"W\n" +
	...
	"\x05Login\x12\x12.user.LoginRequest\x1a\x13.user.LoginResponseB-Z+github.com/maksim/family_app/api/proto/userb\x06proto3"
